...
const ProductListingPage: React.FC = () => {
  ...
  const getFilterDisplayName = useCallback((key: string, value: string | number | boolean) => {
    switch (key) {
      case 'categoryId':
  ...
  const renderPagination = () => {
    ...
    if (meta.totalPages <= maxPagesToShow) {
      ...
      } else if (meta.currentPage + Math.floor(maxPagesToShow / 2) >= meta.totalPages) {
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 p-4 mb-6">
            ...
            {hasActiveFilters && (
              <div className="mt-4 flex items-center gap-2 flex-wrap">
                <h3 className="text-sm font-medium text-gray-800 dark:text-white">Active Filters:</h3>
            ...
            <>
              ...
              <div className="mt-8 space-y-4">
                <div className="flex items-center justify-between text-sm text-gray-600 dark:text-gray-300">
                  <span>
                    Showing {products.length} of {meta?.totalCount || 0} products
                  </span>
                  {meta && (
                    <span>
