...
const ProductSearchHandler = ({ onFiltersUpdate }: { onFiltersUpdate: (filters: ProductFilters) => void }) => {
...
const ProductListingPage: React.FC = () => {
  ...
  const handleFiltersUpdate = useCallback((newFilters: ProductFilters) => {
  ...
  return (
    <Suspense fallback={<ProductGridSkeleton count={12} />}>
      <ProductSearchHandler onFiltersUpdate={handleFiltersUpdate} />
